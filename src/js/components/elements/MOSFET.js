...
class MOSFET extends Element {
    constructor(x, y, threshold, type) {
        super(x, y, type + 'mosfet');
...
export class nMOSFET extends MOSFET {
    constructor(x, y, threshold) {
        super(x, y, threshold, 'n');
    }
}

export class pMOSFET extends MOSFET {
    constructor(x, y, threshold) {
        super(x, y, threshold, 'p');
    }
}